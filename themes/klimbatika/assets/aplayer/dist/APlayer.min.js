                ...
                return i(e, [{
                    ...
                    value: function() {
                        ...
                        this.player.template.list.addEventListener("click", function(t) {
                            ...
                            document.getElementById('player-controls').querySelector(".player-controls__btn_play").classList.add('player-controls__play-active');
                    ...
                    value: function(e) {
                        ...
                        /*
                        *
                        * this.trackTitle = this.container.querySelector(".track__title"),
                            this.trackArtist = this.container.querySelector(".track__artists"),
                            this.trackPtime = this.container.querySelector(".track__ptime"),
                            this.trackDtime = this.container.querySelector(".track__dtime")
                        * */
                        ...
                        void 0 !== e && this.audios[e]) {
                            ...
                            this.player.template.trackTitle.innerHTML = t.name;
                            this.player.template.trackArtist.innerHTML = t.artist ? t.artist : "";
                            ...
                            1 !== this.player.duration && (this.player.template.trackDtime.innerHTML = r.default.secondToTime(this.player.duration));
                        }
                    }
                }, {
                    key: "clear",
                    value: function() {
                        ...
                        this.player.template.trackDtime.innerHTML = r.default.secondToTime(0);
                    }
                }]),
                    e
            }();
                ...
                return i(e, [{
                    ...
                    value: function() {
                        ...
                        this.player.template.pic.addEventListener("click", function() {
                            e.player.toggle();
                            document.getElementById('player-controls').querySelector(".player-controls__btn_play").classList.toggle('player-controls__play-active');
                        })
                    }
                }, {
                    key: "initPlayBar",
                    value: function() {
                        ...
                        t = function(t) {
                            ...
                            e.player.template.trackPtime.innerHTML = a.default.secondToTime(n * e.player.duration);
                        }
                        n = function n(i) {
                        ...
                        t = function(t) {
                            var n = ((t.clientX || t.changedTouches[0].clientX) - a.default.getElementViewLeft(e.player.template.trackBarWrap)) / e.player.template.trackBarWrap.clientWidth;

                            n = Math.max(n, 0);
                            n = Math.min(n, 1);
                            e.player.bar.set("trackPlayed", n, "width");
                            e.player.lrc && e.player.lrc.update(n * e.player.duration);
                            e.player.template.ptime.innerHTML = a.default.secondToTime(n * e.player.duration);
                            e.player.template.trackPtime.innerHTML = a.default.secondToTime(n * e.player.duration);
                        }
                        n = function n(i) {
                            document.removeEventListener(a.default.nameMap.dragEnd, n);
                            document.removeEventListener(a.default.nameMap.dragMove, t);
                            var r = ((i.clientX || i.changedTouches[0].clientX) - a.default.getElementViewLeft(e.player.template.trackBarWrap)) / e.player.template.trackBarWrap.clientWidth;
                            r = Math.max(r, 0);
                            r = Math.min(r, 1);
                            e.player.bar.set("trackPlayed", r, "width");
                            e.player.seek(e.player.bar.get("trackPlayed", "width") * e.player.duration);
                            e.player.disableTimeupdate = !1;
                        };
                        this.player.template.trackBarWrap.addEventListener(a.default.nameMap.dragStart, function() {
                    ...
                    value: function() {
                        ...
                        this.player.template.skipBackButton.addEventListener("click", function() {
                            e.player.skipBack();
                            document.querySelector(".track__title").innerHTML = e.player.template.title.innerHTML;
                            document.querySelector(".track__artist").innerHTML = e.player.template.trackArtist.innerHTML;
                        }),
                            this.player.template.trackButtonPrev.addEventListener("click", function() {
                                e.player.skipBack();
                                document.querySelector(".track__title").innerHTML = e.player.template.title.innerHTML;
                                document.querySelector(".track__artist").innerHTML = e.player.template.trackArtist.innerHTML;
                            }),
                            ...
                            this.player.template.trackButtonNext.addEventListener("click", function() {
                                e.player.skipForward();
                                document.querySelector(".track__title").innerHTML = e.player.template.title.innerHTML;
                                document.querySelector(".track__artist").innerHTML = e.player.template.trackArtist.innerHTML;
                            }),
                            ...
                            this.player.template.trackPlay.addEventListener("click", function() {
                                e.player.toggle();
                                this.classList.toggle('player-controls__play-active');
                            })
                    }
                }, {
                    key: "initLrcButton",
            ...
            var a = function() {
                function e(t) {
                    !function(e, t) {
                        ...
                        this.elements.trackPlayed = t.trackPlayed,
                        this.elements.trackLoaded = t.trackLoaded;
                }
                return i(e, [{
                    key: "set",
            ...
            var s = function() {
                ...
                return i(e, [{
                    ...
                    value: function() {
                        ...
                        this.trackTitle = document.getElementById('player-controls__title').querySelector('.track__title');
                        this.trackArtist = document.getElementById('player-controls__title').querySelector('.track__artist');
                        this.trackPtime = document.getElementById('track__ptime');
                        this.trackDtime = document.getElementById('track__dtime');
                        this.trackButtonPrev = document.getElementById('player-controls').querySelector('.player-controls__btn_prev');
                        this.trackButtonNext = document.getElementById('player-controls').querySelector('.player-controls__btn_next');
                        this.trackPlay = document.getElementById('player-controls').querySelector('.player-controls__btn_play');

                        this.trackPlayed = document.getElementById('player-controls__bar-wrap').querySelector('.player-controls__played');
                        this.trackLoaded = document.getElementById('player-controls__bar-wrap').querySelector('.player-controls__loaded');
                        this.trackThumb = document.getElementById('player-controls__bar-wrap').querySelector('.player-controls__thumb');


                        this.trackBarWrap = document.getElementById('player-controls__bar-wrap').querySelector('.player-controls__bar');


                        /*
                        this.trackTitle = this.container.querySelectorAll(".track__title"),
                        this.trackArtist = this.container.querySelectorAll(".track__artist"),
                        this.trackPtime = this.container.querySelectorAll(".track__ptime"),
                        this.trackButtonPrev = document.querySelectorAll('.player-controls__btn_prev'),
                        this.trackButtonNext = document.querySelectorAll(".player-controls__btn_next")
                        this.trackPlay = document.querySelectorAll(".player-controls__btn_play"),
                            */
                ...
                return i(e, [{
                    ...
                    value: function() {
                        ...
                        t === this.list.index && (this.template.pic.style.backgroundColor = e,
                                ...
                                this.template.trackPlayed.style.background = e,
                                this.template.trackThumb.style.background = e
                        )
                    }
                }, {
                    key: "seek",
                    value: function(e) {
                        e = Math.max(e, 0),
                            ...
                            this.bar.set("trackPlayed", e / this.duration, "width"),
                            this.template.ptime.innerHTML = r.default.secondToTime(e);
                        this.template.trackPtime.innerHTML = r.default.secondToTime(e);
                    }
                }, {
                    key: "setUIPlaying",
                    value: function() {
                    ...
                    key: "title",
                    value: function() {
                        return this.template.title.innerText;
                    }
                }, {
                    key: "duration",
                    get: function() {
